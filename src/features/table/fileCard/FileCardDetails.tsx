    ...
    ({ fileLink, ...props }, ref) => {
        ...
        return (
            <Link
                ...
                className="group col-span-full grid cursor-pointer grid-cols-subgrid items-center gap-3 rounded-xl bg-background-layer-1 p-3 hover:bg-accent hover:text-accent-foreground focus:bg-accent focus:text-accent-foreground"
                href={href}
            ...
            >
                ...
                <Separator
                    ...
                    className="transition-colors group-hover:bg-accent-foreground group-focus:bg-accent-foreground"
                />
